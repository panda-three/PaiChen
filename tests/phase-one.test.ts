...
describe("public storefront state",()=>{
  it("keeps ref on store links and login return",()=>{expect(storeHref("demo","product/p1","staff code")).toBe("/s/demo/product/p1?ref=staff%20code");expect(customerHref("demo","e1","/s/demo/cart?ref=e1")).toContain("returnTo=%2Fs%2Fdemo%2Fcart%3Fref%3De1")});

...
export async function renderStorefront(slug: string, pageSlug: string | undefined, ref: string | undefined) {
  ...
  let defaultCard = { name: catalog.store.name, phone: catalog.store.phone, wechat: null as string | null, wechatQrUrl: null as string | null, title: "店铺顾问", bio: catalog.store.address, avatarUrl: catalog.store.logoUrl };

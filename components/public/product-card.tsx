...
export function ProductCard({ product, slug, refCode, favorite = false, customerActive = false }: { product: PublicProduct; slug: string; refCode?: string; favorite?: boolean; customerActive?: boolean }) {

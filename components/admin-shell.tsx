...
import { ClipboardList, Contact, FolderTree, History, Link2, LogOut, Package, Settings, Store, Users } from "lucide-react";
import { signOut } from "@/auth";

const menu = {
  [Role.PLATFORM_ADMIN]: [{ href: "/admin/stores", label: "店铺管理", icon: Store }],
  [Role.STORE_ADMIN]: [
